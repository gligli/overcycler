...
#define DACSPI_CHANNEL_WAIT_STATES 15
#define DACSPI_TIMER_MATCH 11
#define DACSPI_TIME_CONSTANT ((DACSPI_CHANNEL_COUNT-1)*(2+1+DACSPI_CHANNEL_WAIT_STATES)+(1+1+DACSPI_CHANNEL_WAIT_STATES)) // one tick per channel per DMA access
