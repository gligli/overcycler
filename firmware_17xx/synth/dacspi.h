...
#define DACSPI_OSC_CHANNEL_WAIT_STATES 7
#define DACSPI_CV_CHANNEL_WAIT_STATES 8
#define DACSPI_TIMER_MATCH 24
#define DACSPI_TIME_CONSTANT ((DACSPI_CHANNEL_COUNT-1)*(2+1+DACSPI_OSC_CHANNEL_WAIT_STATES)+(2+1+4+DACSPI_CV_CHANNEL_WAIT_STATES)) // one tick per channel per DMA access
